...
pub unsafe fn nt_get_context_thread(thread_handle: HANDLE, context: *mut Context64) -> NTSTATUS {
    unsafe {
        let table = ssn_table::syscall_table();
...
pub unsafe fn nt_set_context_thread(thread_handle: HANDLE, context: *mut Context64) -> NTSTATUS {
    unsafe {
        let table = ssn_table::syscall_table();
